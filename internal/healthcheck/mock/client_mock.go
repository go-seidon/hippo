...
// Source: internal/healthcheck/client.go
...
func (m *MockHealthClient) AddChecks(cfgs []*healthcheck.HealthConfig) error {
	m.ctrl.T.Helper()
...
func (m *MockHealthClient) State() (map[string]healthcheck.HealthState, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "State")
	ret0, _ := ret[0].(map[string]healthcheck.HealthState)
	ret1, _ := ret[1].(bool)
	ret2, _ := ret[2].(error)
