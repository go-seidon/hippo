...
echo "granting user in $m1_ct_name for replication...  "
...
echo "checking master status in $m1_ct_name...  "
...
echo "adding replica in $r1_ct_name...  "
...
echo "showing $r1_ct_name status...  "
...
echo "running db migration in $r1_ct_name...  "
...
echo "granting user in $r1_ct_name for replication...  "
...
echo "checking master status in $r1_ct_name...  "
...
echo "adding replica in $r2_ct_name...  "
echo "master host         : $(docker-ip $r1_ct_name)"
echo "username            : $r2_db_username"
echo "password            : $r2_db_password"
echo "log file            : $r1_log_file"
echo "log position        : $r1_log_position"
add_r2_stmt='CHANGE MASTER TO MASTER_HOST="'$(docker-ip $r1_ct_name)'", MASTER_USER="'$r2_db_username'", MASTER_PASSWORD="'$r2_db_password'", MASTER_LOG_FILE="'$r1_log_file'", MASTER_LOG_POS='$r1_log_position'; STOP SLAVE; START SLAVE;'
...
echo "showing $r2_ct_name status...  "
r1_status_res=`docker exec $r2_ct_name sh -c "export MYSQL_PWD=$r2_db_root_password; mysql -u $r2_db_root_username -e 'SHOW SLAVE STATUS\G'"`
echo "$r2_status_res"
printf "[DONE]\n\n"

# 16. running db migration in r2
echo "running db migration in $r2_ct_name...  "
