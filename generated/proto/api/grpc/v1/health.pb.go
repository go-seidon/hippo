...
func (x *CheckHealthParam) Reset() {
	*x = CheckHealthParam{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_grpc_v1_health_proto_msgTypes[0]
...
func (*CheckHealthParam) Descriptor() ([]byte, []int) {
	return file_api_grpc_v1_health_proto_rawDescGZIP(), []int{0}
}
...
func (x *CheckHealthResult) Reset() {
	*x = CheckHealthResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_grpc_v1_health_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CheckHealthResult) Descriptor() ([]byte, []int) {
	return file_api_grpc_v1_health_proto_rawDescGZIP(), []int{1}
}
...
func (x *CheckHealthData) Reset() {
	*x = CheckHealthData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_grpc_v1_health_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CheckHealthData) Descriptor() ([]byte, []int) {
	return file_api_grpc_v1_health_proto_rawDescGZIP(), []int{2}
}
...
func (x *CheckHealthDetail) Reset() {
	*x = CheckHealthDetail{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_grpc_v1_health_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CheckHealthDetail) Descriptor() ([]byte, []int) {
	return file_api_grpc_v1_health_proto_rawDescGZIP(), []int{3}
}
...
var File_api_grpc_v1_health_proto protoreflect.FileDescriptor

var file_api_grpc_v1_health_proto_rawDesc = []byte{
	0x0a, 0x18, 0x61, 0x70, 0x69, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x76, 0x31, 0x2f, 0x68, 0x65,
...
var (
	file_api_grpc_v1_health_proto_rawDescOnce sync.Once
	file_api_grpc_v1_health_proto_rawDescData = file_api_grpc_v1_health_proto_rawDesc
)

func file_api_grpc_v1_health_proto_rawDescGZIP() []byte {
	file_api_grpc_v1_health_proto_rawDescOnce.Do(func() {
		file_api_grpc_v1_health_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_grpc_v1_health_proto_rawDescData)
	})
	return file_api_grpc_v1_health_proto_rawDescData
}

var file_api_grpc_v1_health_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_api_grpc_v1_health_proto_goTypes = []interface{}{
...
var file_api_grpc_v1_health_proto_depIdxs = []int32{
...
func init() { file_api_grpc_v1_health_proto_init() }
func file_api_grpc_v1_health_proto_init() {
	if File_api_grpc_v1_health_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_api_grpc_v1_health_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_grpc_v1_health_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_grpc_v1_health_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_grpc_v1_health_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_grpc_v1_health_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_api_grpc_v1_health_proto_goTypes,
		DependencyIndexes: file_api_grpc_v1_health_proto_depIdxs,
		MessageInfos:      file_api_grpc_v1_health_proto_msgTypes,
	}.Build()
	File_api_grpc_v1_health_proto = out.File
	file_api_grpc_v1_health_proto_rawDesc = nil
	file_api_grpc_v1_health_proto_goTypes = nil
	file_api_grpc_v1_health_proto_depIdxs = nil
}
